<!DOCTYPE html><meta charset="UTF-8"><meta http-equiv="Content-Language" content="en" /><title>webdriver.http</title><link href="dossier.css" rel="stylesheet" type="text/css"><div id="main-wrapper"><input type="checkbox" id="sidenav-toggle" /><main><header><h1>Namespace webdriver.http</h1><a class="source" href="source/lib/webdriver/http/http.js.src.html#l20">code &raquo;</a></header><section></section><section><h2>Interfaces</h2><div class="type-summary"><table><tbody><tr><td><dl><dt><a href="interface_webdriver_http_Client.html">webdriver.http.Client</a><dd>Interface used for sending individual HTTP requests to the server.</dl></table></div></section><section><h2>Classes</h2><div class="type-summary"><table><tbody><tr><td><dl><dt><a href="class_webdriver_http_CorsClient.html">webdriver.http.CorsClient</a><dd>Communicates with a WebDriver server, which may be on a different domain,
