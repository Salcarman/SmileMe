<!DOCTYPE html><meta charset="UTF-8"><meta http-equiv="Content-Language" content="en" /><title>webdriver.WebDriver.TargetLocator</title><link href="dossier.css" rel="stylesheet" type="text/css"><div id="main-wrapper"><input type="checkbox" id="sidenav-toggle" /><main><header><h1>Class webdriver.WebDriver.TargetLocator</h1><a class="source" href="source/lib/webdriver/webdriver.js.src.html#l1477">code &raquo;</a></header><section><p>An interface for changing the focus of the driver to another frame or window.<h2>Constructor</h2><div class="ctor wrap-details public"><div><div class="ctor"><span class="member">webdriver.WebDriver.TargetLocator <span class="args">( driver )</span></span></div><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>driver: <code class="type">!<a href="class_webdriver_WebDriver.html">webdriver.WebDriver</a></code><dd>The parent driver.</dl></table></div></div></div></section><div id="visibility-controls"><b>Show:</b><label for="show-public"><span><input type="checkbox" id="show-public" checked/></span>Public</label><label for="show-protected"><span><input type="checkbox" id="show-protected"/></span>Protected</label><label for="show-private"><span><input type="checkbox" id="show-private"/></span>Private</label></div><section id="instance-methods"><h2>Instance Methods</h2><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/webdriver/webdriver.js.src.html#l1490">code &raquo;</a><span class="member"><a name="activeElement">activeElement</a> <span class="args">( )</span> &rArr; <code class="type">!<a href="class_webdriver_WebElementPromise.html">webdriver.WebElementPromise</a></code></span></div><p>Schedules a command retrieve the <code >document.activeElement</code> element on
 the current document, or <code >document.body</code> if activeElement is not
 available.</summary><div class="info"><table><tbody><tr><th>Returns<tr><td><dl>The active element.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/webdriver/webdriver.js.src.html#l1564">code &raquo;</a><span class="member"><a name="alert">alert</a> <span class="args">( )</span> &rArr; <code class="type">!<a href="class_webdriver_AlertPromise.html">webdriver.AlertPromise</a></code></span></div><p>Schedules a command to change focus to the active alert dialog. This command
 will return a <code  class="type"><a href="enum_bot_ErrorCode.html#bot.ErrorCode.NO_SUCH_ALERT">bot.ErrorCode.NO_SUCH_ALERT</a></code> error if an alert dialog
 is not currently open.</summary><div class="info"><table><tbody><tr><th>Returns<tr><td><dl>The open alert.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/webdriver/webdriver.js.src.html#l1504">code &raquo;</a><span class="member"><a name="defaultContent">defaultContent</a> <span class="args">( )</span> &rArr; <code class="type">!<a href="class_webdriver_promise_Promise.html">webdriver.promise.Promise</a>.&lt;void&gt;</code></span></div><p>Schedules a command to switch focus of all future commands to the first frame
 on the page.</summary><div class="info"><table><tbody><tr><th>Returns<tr><td><dl>A promise that will be resolved
     when the driver has changed focus to the default content.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/webdriver/webdriver.js.src.html#l1530">code &raquo;</a><span class="member"><a name="frame">frame</a> <span class="args">( nameOrIndex )</span> &rArr; <code class="type">!<a href="class_webdriver_promise_Promise.html">webdriver.promise.Promise</a>.&lt;void&gt;</code></span></div><p>Schedules a command to switch the focus of all future commands to another
 frame on the page.
 <p/>
 ...
 with a <code >bot.ErrorCode.NO_SUCH_FRAME</code> error.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>nameOrIndex: <code class="type">(<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a>|<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a>)</code><dd>The frame locator.</dl><tr><th>Returns<tr><td><dl>A promise that will be resolved
     when the driver has changed focus to the specified frame.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/webdriver/webdriver.js.src.html#l1550">code &raquo;</a><span class="member"><a name="window">window</a> <span class="args">( nameOrHandle )</span> &rArr; <code class="type">!<a href="class_webdriver_promise_Promise.html">webdriver.promise.Promise</a>.&lt;void&gt;</code></span></div><p>Schedules a command to switch the focus of all future commands to another
