<!DOCTYPE html><meta charset="UTF-8"><meta http-equiv="Content-Language" content="en" /><title>goog.json</title><link href="dossier.css" rel="stylesheet" type="text/css"><div id="main-wrapper"><input type="checkbox" id="sidenav-toggle" /><main><header><h1>Namespace goog.json</h1><a class="source" href="source/lib/goog/json/json.js.src.html#l21">code &raquo;</a></header><section></section><section><h2>Classes</h2><div class="type-summary"><table><tbody><tr><td><dl><dt><a href="class_goog_json_Serializer.html">goog.json.Serializer</a><dd>Class that is used to serialize JSON objects to a string.</dl></table></div></section><div id="visibility-controls"><b>Show:</b><label for="show-public"><span><input type="checkbox" id="show-public" checked/></span>Public</label><label for="show-protected"><span><input type="checkbox" id="show-protected"/></span>Protected</label><label for="show-private"><span><input type="checkbox" id="show-private"/></span>Private</label></div><section id="typedefs"><h2>Type Definitions</h2><div class="wrap-details public"><div><details><summary><div><a class="source" href="source/lib/goog/json/json.js.src.html#l132">code &raquo;</a><a class="member" name="goog.json.Replacer">goog.json.Replacer</a> : <code class="type">function(this: <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object">Object</a>, <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a>, *): *</code></div><div>JSON replacer, as defined in Section 15.12.3 of the ES5 spec.</div></summary></details></div></div><div class="wrap-details public"><div><details><summary><div><a class="source" href="source/lib/goog/json/json.js.src.html#l141">code &raquo;</a><a class="member" name="goog.json.Reviver">goog.json.Reviver</a> : <code class="type">function(this: <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object">Object</a>, <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a>, *): *</code></div><div>JSON reviver, as defined in Section 15.12.2 of the ES5 spec.</div></summary></details></div></div></section><section id="static-functions"><h2>Global Functions</h2><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/json/json.js.src.html#l42">code &raquo;</a><span class="member"><a name="goog.json.isValid">goog.json.isValid</a> <span class="args">( s )</span> &rArr; <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a></code></span></div><p>Tests if a string is an invalid JSON string. This only ensures that we are
 not using any invalid characters</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>s: <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></code><dd>The string to test.</dl><tr><th>Returns<tr><td><dl>True if the input is a valid JSON string.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/json/json.js.src.html#l95">code &raquo;</a><span class="member"><a name="goog.json.parse">goog.json.parse</a> <span class="args">( s )</span> &rArr; <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object">Object</a></code></span></div><p>Parses a JSON string and returns the result. This throws an exception if
