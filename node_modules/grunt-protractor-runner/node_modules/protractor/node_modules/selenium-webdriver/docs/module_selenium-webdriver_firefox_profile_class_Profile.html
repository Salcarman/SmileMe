<!DOCTYPE html><meta charset="UTF-8"><meta http-equiv="Content-Language" content="en" /><title>selenium-webdriver/firefox/profile.Profile</title><link href="dossier.css" rel="stylesheet" type="text/css"><div id="main-wrapper"><input type="checkbox" id="sidenav-toggle" /><main><header><h1>Class selenium-webdriver/firefox/profile.Profile</h1><a class="source" href="source/firefox/profile.js.src.html#l406">code &raquo;</a></header><section><p>Models a Firefox proifle directory for use with the FirefoxDriver. The
 <code >Proifle</code> directory uses an in-memory model until <code  class="type"><a class="unresolved-link">#writeToDisk</a></code>
