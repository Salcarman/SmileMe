<!DOCTYPE html><meta charset="UTF-8"><meta http-equiv="Content-Language" content="en" /><title>selenium-webdriver/remote.SeleniumServer</title><link href="dossier.css" rel="stylesheet" type="text/css"><div id="main-wrapper"><input type="checkbox" id="sidenav-toggle" /><main><header><h1>Class selenium-webdriver/remote.SeleniumServer</h1><a class="source" href="source/remote/index.js.src.html#l301">code &raquo;</a><pre><code><a href="module_selenium-webdriver_remote_class_DriverService.html">DriverService</a>
