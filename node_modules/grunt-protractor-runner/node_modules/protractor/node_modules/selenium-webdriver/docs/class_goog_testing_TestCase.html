<!DOCTYPE html><meta charset="UTF-8"><meta http-equiv="Content-Language" content="en" /><title>goog.testing.TestCase</title><link href="dossier.css" rel="stylesheet" type="text/css"><div id="main-wrapper"><input type="checkbox" id="sidenav-toggle" /><main><header><h1>Class goog.testing.TestCase</h1><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l57">code &raquo;</a></header><section><p>A class representing a JsUnit test case.  A TestCase is made up of a number
 ...
 Use <code  class="type"><a class="unresolved-link">#autoDiscoverLifecycle</a></code> and <code  class="type"><a class="unresolved-link">#autoDiscoverTests</a></code><h2>Constructor</h2><div class="ctor wrap-details public"><div><div class="ctor"><span class="member">goog.testing.TestCase <span class="args">( opt_name )</span></span></div><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>opt_name: <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a>=</code><dd>The name of the test case, defaults to
     'Untitled Test Case'.</dl></table></div></div></div></section><section><h2>Classes</h2><div class="type-summary"><table><tbody><tr><td><dl><dt><a href="class_goog_testing_TestCase_Error.html">goog.testing.TestCase.Error</a><dd>A class representing an error thrown by the test<dt><a href="class_goog_testing_TestCase_Result.html">goog.testing.TestCase.Result</a><dd>A class for representing test results.<dt><a href="class_goog_testing_TestCase_Test.html">goog.testing.TestCase.Test</a><dd>A class representing a single test function.<dt><a href="class_Date.html">goog.testing.TestCase.protectedDate_</a><dd>No Description.</dl></table></div></section><section><h2>Enumerations</h2><div class="type-summary"><table><tbody><tr><td><dl><dt><a href="enum_goog_testing_TestCase_Order.html">goog.testing.TestCase.Order</a><dd>The order to run the auto-discovered tests.</dl></table></div></section><div id="visibility-controls"><b>Show:</b><label for="show-public"><span><input type="checkbox" id="show-public" checked/></span>Public</label><label for="show-protected"><span><input type="checkbox" id="show-protected"/></span>Protected</label><label for="show-private"><span><input type="checkbox" id="show-private"/></span>Private</label></div><section id="instance-methods"><h2>Instance Methods</h2><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l289">code &raquo;</a><span class="member"><a name="add">add</a> <span class="args">( test )</span></span></div><p>Adds a new test to the test case.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>test: <code class="type"><a href="class_goog_testing_TestCase_Test.html">goog.testing.TestCase.Test</a></code><dd>The test to add.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l310">code &raquo;</a><span class="member"><a name="addNewTest">addNewTest</a> <span class="args">( name, ref, opt_scope )</span></span></div><p>Creates and adds a new test.
 ...
 other browsers, the array simply contains the global this.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>opt_prefix: <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a>=</code><dd>An optional prefix. If specified, only get things
     ...
     supports the RuntimeObject:
     http://msdn.microsoft.com/en-us/library/ff521039%28VS.85%29.aspx
     TODO: Remove this option.</dl><tr><th>Returns<tr><td><dl>A list of objects that should be inspected.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l1227">code &raquo;</a><span class="member"><a name="goog.testing.TestCase.initializeTestRunner">goog.testing.TestCase.initializeTestRunner</a> <span class="args">( testCase )</span></span></div><p>Initializes the given test case with the global test runner 'G_testRunner'.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>testCase: <code class="type"><a href="class_goog_testing_TestCase.html">goog.testing.TestCase</a></code><dd>The test case to install.</dl></table></div></details></div></div><div class="wrap-details private"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l189">code &raquo;</a><span class="member"><a name="goog.testing.TestCase.protectedClearTimeout_">goog.testing.TestCase.protectedClearTimeout_</a> <span class="args">( )</span></span></div><p>Save a reference to <code >window.clearTimeout</code>, so any code that overrides
 the default behavior (e.g. MockClock) doesn't affect our runner.</summary></details></div></div><div class="wrap-details private"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l180">code &raquo;</a><span class="member"><a name="goog.testing.TestCase.protectedSetTimeout_">goog.testing.TestCase.protectedSetTimeout_</a> <span class="args">( )</span> &rArr; <code class="type">number</code></span></div><p>Save a reference to <code >window.setTimeout</code>, so any code that overrides the
 default behavior (the MockClock, for example) doesn't affect our runner.</summary></details></div></div></section><section id="static-properties"><h2>Static Properties</h2><div class="wrap-details public"><div><details><summary><div><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l224">code &raquo;</a><span class="member"><a name="goog.testing.TestCase.IS_IE">goog.testing.TestCase.IS_IE</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a></code></span></div><p>Avoid a dependency on goog.userAgent and keep our own reference of whether
 the browser is IE.</summary></details></div></div><div class="wrap-details public"><div><details><summary><div><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l216">code &raquo;</a><span class="member"><a name="goog.testing.TestCase.currentTestName">goog.testing.TestCase.currentTestName</a> : <code class="type">?<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></code></span></div><p>TODO(user) replace this with prototype.currentTest.
 Name of the current test that is running, or null if none is running.</summary></details></div></div><div class="wrap-details public"><div><details><summary><div><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l164">code &raquo;</a><span class="member"><a name="goog.testing.TestCase.maxRunTime">goog.testing.TestCase.maxRunTime</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code></span></div><p>The maximum amount of time that the test can run before we force it to be
 async.  This prevents the test runner from blocking the browser and
 potentially hurting the Selenium test harness.</summary></details></div></div><div class="wrap-details private"><div><details><summary><div><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l208">code &raquo;</a><span class="member"><a name="goog.testing.TestCase.setTimeoutAsString_">goog.testing.TestCase.setTimeoutAsString_</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></code></span></div><p>Saved string referencing goog.global.setTimeout's string serialization.  IE
 sometimes fails to uphold equality for setTimeout, but the string version
 stays the same.</summary></details></div></div></section></main><nav id="topnav"><div><div id="menubutton"><label for="sidenav-toggle">Menu</label></div><form id="searchbox"><div><input type="search" placeholder="Search" tabindex="1"></div></form></div></nav><nav id="sidenav"><input type="checkbox" id="sidenav-types-ctrl" /><input type="checkbox" id="sidenav-files-ctrl" /><input type="checkbox" id="sidenav-modules-ctrl" /><a id="sidenav-overview"><div><h4>Overview</h4></div></a><div id="sidenav-types"><label for="sidenav-types-ctrl"><h4>Types</h4></label><i>Loading</i></div><div id="sidenav-modules"><label for="sidenav-modules-ctrl"><h4>Modules</h4></label><i>Loading</i></div><div id="sidenav-files"><label for="sidenav-files-ctrl"><h4>Files</h4></label><i>Loading</i></div><a href="license.html"><div><h4>License</h4></div></a></nav><div id="push-footer"></div></div><footer><a href="https://github.com/jleyba/js-dossier">Generated by dossier</a></footer><script src="types.js"></script><script src="dossier.js"></script>
