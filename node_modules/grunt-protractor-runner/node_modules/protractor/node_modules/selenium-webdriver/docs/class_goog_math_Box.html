<!DOCTYPE html><meta charset="UTF-8"><meta http-equiv="Content-Language" content="en" /><title>goog.math.Box</title><link href="dossier.css" rel="stylesheet" type="text/css"><div id="main-wrapper"><input type="checkbox" id="sidenav-toggle" /><main><header><h1>Class goog.math.Box</h1><a class="source" href="source/lib/goog/math/box.js.src.html#l39">code &raquo;</a></header><section><p>Class for representing a box. A box is specified as a top, right, bottom,
 ...
 and y dimension values.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>tx: <code class="type">(<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a>|<a href="class_goog_math_Coordinate.html">goog.math.Coordinate</a>)</code><dd>The value to translate the x
     dimension values by or the the coordinate to translate this box by.<dt>opt_ty: <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a>=</code><dd>The value to translate y dimension values by.</dl><tr><th>Returns<tr><td><dl>This box after translating.</dl></table></div></details></div></div></section><section id="instance-properties"><h2>Instance Properties</h2><div class="wrap-details public"><div><details><summary><div><a class="source" href="source/lib/goog/math/box.js.src.html#l56">code &raquo;</a><span class="member"><a name="bottom">bottom</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code></span></div><p>Bottom</summary></details></div></div><div class="wrap-details public"><div><details><summary><div><a class="source" href="source/lib/goog/math/box.js.src.html#l62">code &raquo;</a><span class="member"><a name="left">left</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code></span></div><p>Left</summary></details></div></div><div class="wrap-details public"><div><details><summary><div><a class="source" href="source/lib/goog/math/box.js.src.html#l50">code &raquo;</a><span class="member"><a name="right">right</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code></span></div><p>Right</summary></details></div></div><div class="wrap-details public"><div><details><summary><div><a class="source" href="source/lib/goog/math/box.js.src.html#l44">code &raquo;</a><span class="member"><a name="top">top</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code></span></div><p>Top</summary></details></div></div></section><section id="static-functions"><h2>Static Functions</h2><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/math/box.js.src.html#l72">code &raquo;</a><span class="member"><a name="goog.math.Box.boundingBox">goog.math.Box.boundingBox</a> <span class="args">( var_args )</span> &rArr; <code class="type">!<a href="class_goog_math_Box.html">goog.math.Box</a></code></span></div><p>Creates a Box by bounding a collection of goog.math.Coordinate objects</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>var_args: <code class="type">...<a href="class_goog_math_Coordinate.html">goog.math.Coordinate</a></code><dd>Coordinates to be included inside
     the box.</dl><tr><th>Returns<tr><td><dl>A Box containing all the specified Coordinates.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/math/box.js.src.html#l202">code &raquo;</a><span class="member"><a name="goog.math.Box.contains">goog.math.Box.contains</a> <span class="args">( box, other )</span> &rArr; <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a></code></span></div><p>Returns whether a box contains a coordinate or another box.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>box: <code class="type"><a href="class_goog_math_Box.html">goog.math.Box</a></code><dd>A Box.<dt>other: <code class="type">(<a href="class_goog_math_Coordinate.html">goog.math.Coordinate</a>|<a href="class_goog_math_Box.html">goog.math.Box</a>)</code><dd>A Coordinate or a Box.</dl><tr><th>Returns<tr><td><dl>Whether the box contains the coordinate or other box.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/math/box.js.src.html#l266">code &raquo;</a><span class="member"><a name="goog.math.Box.distance">goog.math.Box.distance</a> <span class="args">( box, coord )</span> &rArr; <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code></span></div><p>Returns the distance between a coordinate and the nearest corner/side of a
 box. Returns zero if the coordinate is inside the box.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>box: <code class="type"><a href="class_goog_math_Box.html">goog.math.Box</a></code><dd>A Box.<dt>coord: <code class="type"><a href="class_goog_math_Coordinate.html">goog.math.Coordinate</a></code><dd>A Coordinate.</dl><tr><th>Returns<tr><td><dl>The distance between <code >coord</code> and the nearest
     ...
     <code >box</code>.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/math/box.js.src.html#l183">code &raquo;</a><span class="member"><a name="goog.math.Box.equals">goog.math.Box.equals</a> <span class="args">( a, b )</span> &rArr; <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a></code></span></div><p>Compares boxes for equality.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>a: <code class="type"><a href="class_goog_math_Box.html">goog.math.Box</a></code><dd>A Box.<dt>b: <code class="type"><a href="class_goog_math_Box.html">goog.math.Box</a></code><dd>A Box.</dl><tr><th>Returns<tr><td><dl>True iff the boxes are equal, or if both are null.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/math/box.js.src.html#l280">code &raquo;</a><span class="member"><a name="goog.math.Box.intersects">goog.math.Box.intersects</a> <span class="args">( a, b )</span> &rArr; <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a></code></span></div><p>Returns whether two boxes intersect.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>a: <code class="type"><a href="class_goog_math_Box.html">goog.math.Box</a></code><dd>A Box.<dt>b: <code class="type"><a href="class_goog_math_Box.html">goog.math.Box</a></code><dd>A second Box.</dl><tr><th>Returns<tr><td><dl>Whether the boxes intersect.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/math/box.js.src.html#l294">code &raquo;</a><span class="member"><a name="goog.math.Box.intersectsWithPadding">goog.math.Box.intersectsWithPadding</a> <span class="args">( a, b, padding )</span> &rArr; <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a></code></span></div><p>Returns whether two boxes would intersect with additional padding.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>a: <code class="type"><a href="class_goog_math_Box.html">goog.math.Box</a></code><dd>A Box.<dt>b: <code class="type"><a href="class_goog_math_Box.html">goog.math.Box</a></code><dd>A second Box.<dt>padding: <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code><dd>The additional padding.</dl><tr><th>Returns<tr><td><dl>Whether the boxes intersect.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/math/box.js.src.html#l227">code &raquo;</a><span class="member"><a name="goog.math.Box.relativePositionX">goog.math.Box.relativePositionX</a> <span class="args">( box, coord )</span> &rArr; <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code></span></div><p>Returns the relative x position of a coordinate compared to a box.  Returns
 zero if the coordinate is inside the box.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>box: <code class="type"><a href="class_goog_math_Box.html">goog.math.Box</a></code><dd>A Box.<dt>coord: <code class="type"><a href="class_goog_math_Coordinate.html">goog.math.Coordinate</a></code><dd>A Coordinate.</dl><tr><th>Returns<tr><td><dl>The x position of <code >coord</code> relative to the nearest
     side of <code >box</code>, or zero if <code >coord</code> is inside <code >box</code>.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/math/box.js.src.html#l246">code &raquo;</a><span class="member"><a name="goog.math.Box.relativePositionY">goog.math.Box.relativePositionY</a> <span class="args">( box, coord )</span> &rArr; <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code></span></div><p>Returns the relative y position of a coordinate compared to a box.  Returns
