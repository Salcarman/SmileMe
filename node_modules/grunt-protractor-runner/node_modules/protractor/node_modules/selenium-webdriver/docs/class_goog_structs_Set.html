<!DOCTYPE html><meta charset="UTF-8"><meta http-equiv="Content-Language" content="en" /><title>goog.structs.Set</title><link href="dossier.css" rel="stylesheet" type="text/css"><div id="main-wrapper"><input type="checkbox" id="sidenav-toggle" /><main><header><h1>Class goog.structs.Set.<code class="type">&lt;T&gt;</code></h1><a class="source" href="source/lib/goog/structs/set.js.src.html#l52">code &raquo;</a><dl><dt>All implemented interfaces:<dd><code><a href="">goog.structs.Collection.&lt;(T|null)&gt;</a></code></dl></header><section><p>A set that can contain both primitives and objects.  Adding and removing
 ...
 collection.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>col: <code class="type">(<a href="http://developer.mozilla.org/en/Core_JavaScript_1.5_Reference/Global_Objects/Array">Array</a>.&lt;T&gt;|<a href="interface_goog_structs_Collection.html">goog.structs.Collection</a>.&lt;T&gt;|<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object">Object</a>)</code><dd>A collection.</dl><tr><th>Returns<tr><td><dl>A new set containing all the values
     ...
     collection.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/structs/set.js.src.html#l242">code &raquo;</a><span class="member"><a name="equals">equals</a> <span class="args">( col )</span> &rArr; <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a></code></span></div><p>Tests whether the given collection consists of the same elements as this set,
