<!DOCTYPE html><meta charset="UTF-8"><meta http-equiv="Content-Language" content="en" /><title>goog.events</title><link href="dossier.css" rel="stylesheet" type="text/css"><div id="main-wrapper"><input type="checkbox" id="sidenav-toggle" /><main><header><h1>Namespace goog.events</h1><a class="source" href="source/lib/goog/events/eventid.js.src.html#l15">code &raquo;</a></header><section></section><section><h2>Interfaces</h2><div class="type-summary"><table><tbody><tr><td><dl><dt><a href="interface_goog_events_Listenable.html">goog.events.Listenable</a><dd>A listenable interface.<dt><a href="interface_goog_events_ListenableKey.html">goog.events.ListenableKey</a><dd>An interface that describes a single registered listener.</dl></table></div></section><section><h2>Classes</h2><div class="type-summary"><table><tbody><tr><td><dl><dt><a href="class_goog_events_BrowserEvent.html">goog.events.BrowserEvent</a><dd>Accepts a browser event object and creates a patched, cross browser event
 ...
 function is a proxy for the real listener the user specified.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>listener: <code class="type"><a href="class_goog_events_Listener.html">goog.events.Listener</a></code><dd>The listener object.<dt>opt_evt: <code class="type">Event=</code><dd>Optional event object that gets passed in via the
     native event handlers.</dl><tr><th>Returns<tr><td><dl>Result of the event handler.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/events/events.js.src.html#l627">code &raquo;</a><span class="member"><a name="goog.events.hasListener">goog.events.hasListener</a> <span class="args">( obj, opt_type, opt_capture )</span> &rArr; <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a></code></span></div><p>Returns whether an event target has any active listeners matching the
 ...
 unspecified, the function will match on the remaining criteria.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>obj: <code class="type">(EventTarget|<a href="interface_goog_events_Listenable.html">goog.events.Listenable</a>)</code><dd>Target to get
     ...
     the requested type and/or capture phase.</dl></table></div></details></div></div><div class="wrap-details private"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/events/events.js.src.html#l911">code &raquo;</a><span class="member"><a name="goog.events.isMarkedIeEvent_">goog.events.isMarkedIeEvent_</a> <span class="args">( e )</span> &rArr; <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a></code></span></div><p>This is used to check if an IE event has already been handled by the Closure
 system so we do not do the Closure pass twice for a bubbling event.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>e: <code class="type">Event</code><dd>The IE browser event.</dl><tr><th>Returns<tr><td><dl>True if the event object has been marked.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/events/events.js.src.html#l168">code &raquo;</a><code class="type">&lt;T, EVENTOBJ&gt;</code> <span class="member"><a name="goog.events.listen">goog.events.listen</a> <span class="args">( src, type, listener, opt_capt, opt_handler )</span> &rArr; <code class="type"><a href="namespace_goog_events.html#goog.events.Key">goog.events.Key</a></code></span></div><p>Adds an event listener for a specific event on a native event
 ...
 listener after a call to listen().</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>src: <code class="type">(EventTarget|<a href="interface_goog_events_Listenable.html">goog.events.Listenable</a>)</code><dd>The node to listen
     ...
     false).<dt>opt_handler: <code class="type">T=</code><dd>Element in whose scope to call the listener.</dl><tr><th>Returns<tr><td><dl>Unique key for the listener.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/events/events.js.src.html#l316">code &raquo;</a><code class="type">&lt;T, EVENTOBJ&gt;</code> <span class="member"><a name="goog.events.listenOnce">goog.events.listenOnce</a> <span class="args">( src, type, listener, opt_capt, opt_handler )</span> &rArr; <code class="type"><a href="namespace_goog_events.html#goog.events.Key">goog.events.Key</a></code></span></div><p>Adds an event listener for a specific event on a native event
 target (such as a DOM element) or an object that has implemented
 ...
 only be added once to an object.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>src: <code class="type">(EventTarget|<a href="interface_goog_events_Listenable.html">goog.events.Listenable</a>)</code><dd>The target to
     ...
     false).<dt>opt_handler: <code class="type">T=</code><dd>Element in whose scope to call the listener.</dl></table></div></details></div></div><div class="wrap-details private"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/events/events.js.src.html#l210">code &raquo;</a><span class="member"><a name="goog.events.listen_">goog.events.listen_</a> <span class="args">( src, type, listener, callOnce, opt_capt, opt_handler )</span> &rArr; <code class="type"><a href="interface_goog_events_ListenableKey.html">goog.events.ListenableKey</a></code></span></div><p>Adds an event listener for a specific event on a native event
 ...
 given error handler.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>errorHandler: <code class="type">goog.debug.ErrorHandler</code><dd>Error handler with which to
     protect the entry point.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/events/events.js.src.html#l498">code &raquo;</a><span class="member"><a name="goog.events.removeAll">goog.events.removeAll</a> <span class="args">( obj, opt_type )</span> &rArr; <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code></span></div><p>Removes all listeners from an object. You can also optionally
 remove listeners of a particular type.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>obj: <code class="type">(<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object">Object</a>|<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Undefined">undefined</a>)</code><dd>Object to remove listeners from. Must be an
     ...
     Default is all types.</dl><tr><th>Returns<tr><td><dl>Number of listeners removed.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/events/events.js.src.html#l543">code &raquo;</a><span class="member deprecation-notice"><a name="goog.events.removeAllNativeListeners">goog.events.removeAllNativeListeners</a> <span class="args">( )</span> &rArr; <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code></span></div><div class="deprecation-notice">Deprecated: <span class="deprecation-reason">This doesn't do anything, now that Closure no longer
 ...
 goog.events.EventTarget listeners will NOT be removed.</summary><div class="info"><table><tbody><tr><th>Returns<tr><td><dl>Number of listeners removed.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/events/events.js.src.html#l376">code &raquo;</a><code class="type">&lt;EVENTOBJ&gt;</code> <span class="member"><a name="goog.events.unlisten">goog.events.unlisten</a> <span class="args">( src, type, listener, opt_capt, opt_handler )</span> &rArr; <code class="type">?<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a></code></span></div><p>Removes an event listener which was added with listen().</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>src: <code class="type">(EventTarget|<a href="interface_goog_events_Listenable.html">goog.events.Listenable</a>)</code><dd>The target to stop
 ...
 returned by listen().</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>key: <code class="type"><a href="namespace_goog_events.html#goog.events.Key">goog.events.Key</a></code><dd>The key returned by listen() for this
     ...
     returned.</dl></table></div></details></div></div></section><section id="static-properties"><h2>Global Properties</h2><div class="wrap-details private"><div><details><summary><div><a class="source" href="source/lib/goog/events/events.js.src.html#l86">code &raquo;</a><span class="member"><a name="goog.events.LISTENER_MAP_PROP_">goog.events.LISTENER_MAP_PROP_</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></code></span></div><p>Property name on a native event target for the listener map
 associated with the event target.</summary></details></div></div><div class="wrap-details private"><div><details><summary><div><a class="source" href="source/lib/goog/events/events.js.src.html#l954">code &raquo;</a><span class="member"><a name="goog.events.LISTENER_WRAPPER_PROP_">goog.events.LISTENER_WRAPPER_PROP_</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></code></span></div><p>Expando property for listener function wrapper for Object with
 handleEvent.</summary></details></div></div><div class="wrap-details private"><div><details><summary><div><a class="source" href="source/lib/goog/events/events.js.src.html#l142">code &raquo;</a><span class="member"><a name="goog.events.listenerCountEstimate_">goog.events.listenerCountEstimate_</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code></span></div><p>Estimated count of total native listeners.</summary></details></div></div><div class="wrap-details private"><div><details><summary><div><a class="source" href="source/lib/goog/events/events.js.src.html#l105">code &raquo;</a><span class="member"><a name="goog.events.onStringMap_">goog.events.onStringMap_</a> : <code class="type">{}</code></span></div><p>Map of computed "on<eventname>" strings for IE event types. Caching
 this removes an extra object allocation in goog.events.listen which
 improves IE6 performance.</summary></details></div></div><div class="wrap-details private"><div><details><summary><div><a class="source" href="source/lib/goog/events/events.js.src.html#l94">code &raquo;</a><span class="member"><a name="goog.events.onString_">goog.events.onString_</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></code></span></div><p>String used to prepend to IE event types.</summary></details></div></div><div class="wrap-details private"><div><details><summary><div><a class="source" href="source/lib/goog/events/events.js.src.html#l920">code &raquo;</a><span class="member"><a name="goog.events.uniqueIdCounter_">goog.events.uniqueIdCounter_</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code></span></div><p>Counter to create unique event ids.</summary></details></div></div></section><section id="compiler-constants"><h2>Compiler Constants</h2><div class="wrap-details public"><div><details><summary><div><a class="source" href="source/lib/goog/events/events.js.src.html#l135">code &raquo;</a><span class="member"><a name="goog.events.CAPTURE_SIMULATION_MODE">goog.events.CAPTURE_SIMULATION_MODE</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code></span></div></summary></details></div></div></section></main><nav id="topnav"><div><div id="menubutton"><label for="sidenav-toggle">Menu</label></div><form id="searchbox"><div><input type="search" placeholder="Search" tabindex="1"></div></form></div></nav><nav id="sidenav"><input type="checkbox" id="sidenav-types-ctrl" /><input type="checkbox" id="sidenav-files-ctrl" /><input type="checkbox" id="sidenav-modules-ctrl" /><a id="sidenav-overview"><div><h4>Overview</h4></div></a><div id="sidenav-types"><label for="sidenav-types-ctrl"><h4>Types</h4></label><i>Loading</i></div><div id="sidenav-modules"><label for="sidenav-modules-ctrl"><h4>Modules</h4></label><i>Loading</i></div><div id="sidenav-files"><label for="sidenav-files-ctrl"><h4>Files</h4></label><i>Loading</i></div><a href="license.html"><div><h4>License</h4></div></a></nav><div id="push-footer"></div></div><footer><a href="https://github.com/jleyba/js-dossier">Generated by dossier</a></footer><script src="types.js"></script><script src="dossier.js"></script>
