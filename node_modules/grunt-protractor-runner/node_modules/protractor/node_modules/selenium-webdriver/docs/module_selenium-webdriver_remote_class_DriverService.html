<!DOCTYPE html><meta charset="UTF-8"><meta http-equiv="Content-Language" content="en" /><title>selenium-webdriver/remote.DriverService</title><link href="dossier.css" rel="stylesheet" type="text/css"><div id="main-wrapper"><input type="checkbox" id="sidenav-toggle" /><main><header><h1>Class selenium-webdriver/remote.DriverService</h1><a class="source" href="source/remote/index.js.src.html#l300">code &raquo;</a></header><section><p>Manages the life and death of a native executable WebDriver server.
