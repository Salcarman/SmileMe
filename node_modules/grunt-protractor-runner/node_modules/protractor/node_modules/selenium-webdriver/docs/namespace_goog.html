<!DOCTYPE html><meta charset="UTF-8"><meta http-equiv="Content-Language" content="en" /><title>goog</title><link href="dossier.css" rel="stylesheet" type="text/css"><div id="main-wrapper"><input type="checkbox" id="sidenav-toggle" /><main><header><h1>Namespace goog</h1><a class="source" href="source/lib/goog/base.js.src.html#l41">code &raquo;</a></header><section><p>Base namespace for the Closure library.  Checks to see goog is already
 ...
 because that would make it more difficult to obfuscate our JavaScript code.</summary><div class="info"><table><tbody><tr><th>Throws<tr><td><dl><dt><code class="type"><a href="http://developer.mozilla.org/en/Core_JavaScript_1.5_Reference/Global_Objects/Error">Error</a></code><dd>when invoked to indicate the method should be overridden.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/base.js.src.html#l463">code &raquo;</a><span class="member"><a name="goog.addDependency">goog.addDependency</a> <span class="args">( relPath, provides, requires, opt_isModule )</span></span></div><p>Adds a dependency from a file to the files it requires.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>relPath: <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></code><dd>The path to the js file.<dt>provides: <code class="type"><a href="http://developer.mozilla.org/en/Core_JavaScript_1.5_Reference/Global_Objects/Array">Array</a></code><dd>An array of strings with the names of the objects
                         ...
                         this file requires.<dt>opt_isModule: <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a>=</code><dd>Whether this dependency must be loaded as
     a module as declared by goog.module.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/base.js.src.html#l647">code &raquo;</a><span class="member"><a name="goog.addSingletonGetter">goog.addSingletonGetter</a> <span class="args">( ctor )</span></span></div><p>Adds a <code >getInstance</code> static method that always returns the same
 ...
 options.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>name: <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></code><dd>The distinguished name to provide.<dt>defaultValue</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/base.js.src.html#l2064">code &raquo;</a><span class="member"><a name="goog.defineClass">goog.defineClass</a> <span class="args">( superClass, def )</span> &rArr; <code class="type">!<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function">Function</a></code></span></div><p>Creates a restricted form of a Closure "class":
   ...
   - the compiler will rewrite this definition to a form that is optimal
     ...
     "statics": an object literal containing methods to add to the constructor
        ...
        be added.
     all other properties are added to the prototype.</dl><tr><th>Returns<tr><td><dl>The class constructor.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/disposable/disposable.js.src.html#l279">code &raquo;</a><span class="member"><a name="goog.dispose">goog.dispose</a> <span class="args">( obj )</span></span></div><p>Calls <code >dispose</code> on the argument if it supports it. If obj is not an
     object with a dispose() method, this is a no-op.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>obj: <code class="type">*</code><dd>The object to dispose of.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/disposable/disposable.js.src.html#l293">code &raquo;</a><span class="member"><a name="goog.disposeAll">goog.disposeAll</a> <span class="args">( var_args )</span></span></div><p>Calls <code >dispose</code> on each member of the list that supports it. (If the
 member is an ArrayLike, then <code >goog.disposeAll()</code> will be called
 recursively on each of its members.) If the member is not an object with a
 <code >dispose()</code> method, then it is ignored.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>var_args: <code class="type">...*</code><dd>The list.</dl></table></div></details></div></div><div class="wrap-details private"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/base.js.src.html#l116">code &raquo;</a><span class="member"><a name="goog.exportPath_">goog.exportPath_</a> <span class="args">( name, opt_object, opt_objectToExportTo )</span></span></div><p>Builds an object structure for the provided namespace path, ensuring that
 ...
 itself.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>name: <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></code><dd>Namespace provided by this file in the form
     "goog.package.part", is expected but not required.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/base.js.src.html#l1611">code &raquo;</a><span class="member"><a name="goog.now">goog.now</a> <span class="args">( )</span> &rArr; <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code></span></div></summary><div class="info"><table><tbody><tr><th>Returns<tr><td><dl>An integer value representing the number of milliseconds
     between midnight, January 1, 1970 and the current time.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/base.js.src.html#l606">code &raquo;</a><span class="member"><a name="goog.nullFunction">goog.nullFunction</a> <span class="args">( )</span> &rArr; <code class="type">void</code></span></div><p>Null function used for default values of callbacks, etc.</summary><div class="info"><table><tbody><tr><th>Returns<tr><td><dl>Nothing.</dl></table></div></details></div></div><div class="wrap-details private"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/base.js.src.html#l1009">code &raquo;</a><span class="member"><a name="goog.onScriptLoad_">goog.onScriptLoad_</a> <span class="args">( script, scriptIndex )</span> &rArr; <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a></code></span></div><p>A readystatechange handler for legacy IE</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>script<dt>scriptIndex</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/base.js.src.html#l1575">code &raquo;</a><span class="member"><a name="goog.partial">goog.partial</a> <span class="args">( fn, var_args )</span> &rArr; <code class="type">!<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function">Function</a></code></span></div><p>Like bind(), except that a 'this object' is not required. Useful when the
 ...
 stripped by the JSCompiler when the --closure_pass option is used.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>name: <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></code><dd>Namespace to include (as was given in goog.provide()) in
     the form "goog.package.part".</dl><tr><th>Returns<tr><td><dl>If called within a goog.module file, the associated namespace or
     module otherwise null.</dl></table></div></details></div></div><div class="wrap-details private"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/base.js.src.html#l807">code &raquo;</a><span class="member"><a name="goog.retrieveAndExecModule_">goog.retrieveAndExecModule_</a> <span class="args">( src )</span></span></div><p>Retrieve and execute a module.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>src: <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></code><dd>Script source URL.</dl></table></div></details></div></div><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/base.js.src.html#l2018">code &raquo;</a><span class="member"><a name="goog.scope">goog.scope</a> <span class="args">( fn )</span></span></div><p>Allow for aliasing within scope functions.  This function exists for
