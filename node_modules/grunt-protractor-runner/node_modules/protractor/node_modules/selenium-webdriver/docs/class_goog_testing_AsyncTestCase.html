<!DOCTYPE html><meta charset="UTF-8"><meta http-equiv="Content-Language" content="en" /><title>goog.testing.AsyncTestCase</title><link href="dossier.css" rel="stylesheet" type="text/css"><div id="main-wrapper"><input type="checkbox" id="sidenav-toggle" /><main><header><h1>Class goog.testing.AsyncTestCase</h1><a class="source" href="source/lib/goog/testing/asynctestcase.js.src.html#l125">code &raquo;</a><pre><code><a href="class_goog_testing_TestCase.html">goog.testing.TestCase</a>
 ...
 about it.</summary></details></div></div><div class="wrap-details public"><div><details><summary><div><a class="source" href="source/lib/goog/testing/asynctestcase.js.src.html#l691">code &raquo;</a><span class="member"><a name="origAssert_">origAssert_</a> : <code class="type">?</code></span></div></summary></details></div></div><div class="wrap-details public"><div><details><summary><div><a class="source" href="source/lib/goog/testing/asynctestcase.js.src.html#l693">code &raquo;</a><span class="member"><a name="origFail_">origFail_</a> : <code class="type">?</code></span></div></summary></details></div></div><div class="wrap-details private"><div><details><summary><div><a class="source" href="source/lib/goog/testing/asynctestcase.js.src.html#l223">code &raquo;</a><span class="member"><a name="origOnError_">origOnError_</a> : <code class="type">(<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function">Function</a>|<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Undefined">undefined</a>)</code></span></div><p>A reference to the original window.onerror function.</summary></details></div></div><div class="wrap-details private"><div><details><summary><div><a class="source" href="source/lib/goog/testing/asynctestcase.js.src.html#l313">code &raquo;</a><span class="member"><a name="receivedSignalCount_">receivedSignalCount_</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code></span></div><p>Number of signals received.</summary></details></div></div><div class="wrap-details private"><div><details><summary><div><a class="source" href="source/lib/goog/testing/asynctestcase.js.src.html#l322">code &raquo;</a><span class="member"><a name="returnWillPump_">returnWillPump_</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a></code></span></div><p>Flag that tells us if there is a function in the call stack that will make
 a call to pump_().</summary></details></div></div><div class="wrap-details public"><div><details><summary><div><a class="source" href="source/lib/goog/testing/asynctestcase.js.src.html#l184">code &raquo;</a><span class="member"><a name="stepTimeout">stepTimeout</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code></span></div><p>How long to wait for a single step of a test to complete in milliseconds.
 A step starts when a call to waitForAsync() is made.</summary></details></div></div><div class="wrap-details public"><div><details><summary><div><a class="source" href="source/lib/goog/testing/asynctestcase.js.src.html#l193">code &raquo;</a><span class="member"><a name="timeToSleepAfterFailure">timeToSleepAfterFailure</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code></span></div><p>How long to wait after a failed test before moving onto the next one.
 The purpose of this is to allow any pending async callbacks from the failing
 test to finish up and not cause the next test to fail.</summary></details></div></div><div class="wrap-details private"><div><details><summary><div><a class="source" href="source/lib/goog/testing/asynctestcase.js.src.html#l263">code &raquo;</a><span class="member"><a name="timeoutHandle_">timeoutHandle_</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code></span></div><p>The handle to the current setTimeout timer.</summary></details></div></div><h3>Defined in <code class="type"><a href="class_goog_testing_TestCase.html">goog.testing.TestCase</a></code></h3><div class="wrap-details private"><div><details><summary><div><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l266">code &raquo;</a><span class="member"><a name="batchTime_">batchTime_</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code></span></div><p>Time since the last batch of tests was started, if batchTime exceeds
 <code  class="type"><a class="unresolved-link">#maxRunTime</a></code> a timeout will be used to stop the tests blocking the
 browser and a new batch will be started.</summary></details></div></div><div class="wrap-details private"><div><details><summary><div><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l274">code &raquo;</a><span class="member"><a name="currentTestPointer_">currentTestPointer_</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code></span></div><p>Pointer to the current test.</summary></details></div></div><div class="wrap-details protected"><div><details><summary><div><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l234">code &raquo;</a><span class="member"><a name="exceptionBeforeTest">exceptionBeforeTest</a> : <code class="type">*</code></span></div><p>Exception object that was detected before a test runs.</summary></details></div></div><div class="wrap-details private"><div><details><summary><div><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l63">code &raquo;</a><span class="member"><a name="name_">name_</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></code></span></div><p>A name for the test case.</summary></details></div></div><div class="wrap-details private"><div><details><summary><div><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l282">code &raquo;</a><span class="member"><a name="onCompleteCallback_">onCompleteCallback_</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function">Function</a></code></span></div><p>Optional callback that will be executed when the test has finalized.</summary></details></div></div><div class="wrap-details public"><div><details><summary><div><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l171">code &raquo;</a><span class="member"><a name="order">order</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a></code></span></div><p>The order to run the auto-discovered tests in.</summary></details></div></div><div class="wrap-details protected"><div><details><summary><div><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l122">code &raquo;</a><span class="member"><a name="result_">result_</a> : <code class="type"><a href="class_goog_testing_TestCase_Result.html">goog.testing.TestCase.Result</a></code></span></div><p>Object used to encapsulate the test results.</summary></details></div></div><div class="wrap-details public"><div><details><summary><div><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l248">code &raquo;</a><span class="member"><a name="running">running</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a></code></span></div><p>Whether the test case is running.</summary></details></div></div><div class="wrap-details private"><div><details><summary><div><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l256">code &raquo;</a><span class="member"><a name="startTime_">startTime_</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Number">number</a></code></span></div><p>Timestamp for when the test was started.</summary></details></div></div><div class="wrap-details public"><div><details><summary><div><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l241">code &raquo;</a><span class="member"><a name="started">started</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Boolean">boolean</a></code></span></div><p>Whether the test case has ever tried to execute.</summary></details></div></div><div class="wrap-details private"><div><details><summary><div><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l92">code &raquo;</a><span class="member"><a name="testsToRun_">testsToRun_</a> : <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object">Object</a></code></span></div><p>Set of test names and/or indices to execute, or null if all tests should
 be executed.
 ...
 <ul></summary></details></div></div><div class="wrap-details private"><div><details><summary><div><a class="source" href="source/lib/goog/testing/testcase.js.src.html#l70">code &raquo;</a><span class="member"><a name="tests_">tests_</a> : <code class="type">!<a href="http://developer.mozilla.org/en/Core_JavaScript_1.5_Reference/Global_Objects/Array">Array</a></code></span></div><p>Array of test functions that can be executed.</summary></details></div></div></section><section id="static-functions"><h2>Static Functions</h2><div class="wrap-details public"><div><details class="function"><summary><div><a class="source" href="source/lib/goog/testing/asynctestcase.js.src.html#l352">code &raquo;</a><span class="member"><a name="goog.testing.AsyncTestCase.createAndInstall">goog.testing.AsyncTestCase.createAndInstall</a> <span class="args">( opt_name )</span> &rArr; <code class="type">!<a href="class_goog_testing_AsyncTestCase.html">goog.testing.AsyncTestCase</a></code></span></div><p>Preferred way of creating an AsyncTestCase. Creates one and initializes it
 with the G_testRunner.</summary><div class="info"><table><tbody><tr><th>Parameters<tr><td><dl><dt>opt_name: <code class="type"><a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String">string</a>=</code><dd>A descriptive name for the test case.</dl><tr><th>Returns<tr><td><dl>The created AsyncTestCase.</dl></table></div></details></div></div></section><section id="static-properties"><h2>Static Properties</h2><div class="wrap-details public"><div><details><summary><div><a class="source" href="source/lib/goog/testing/asynctestcase.js.src.html#l125">code &raquo;</a><span class="member"><a name="goog.testing.AsyncTestCase.superClass_">goog.testing.AsyncTestCase.superClass_</a> : <code class="type"><a href="class_goog_testing_TestCase.html">goog.testing.TestCase.prototype</a></code></span></div></summary></details></div></div></section></main><nav id="topnav"><div><div id="menubutton"><label for="sidenav-toggle">Menu</label></div><form id="searchbox"><div><input type="search" placeholder="Search" tabindex="1"></div></form></div></nav><nav id="sidenav"><input type="checkbox" id="sidenav-types-ctrl" /><input type="checkbox" id="sidenav-files-ctrl" /><input type="checkbox" id="sidenav-modules-ctrl" /><a id="sidenav-overview"><div><h4>Overview</h4></div></a><div id="sidenav-types"><label for="sidenav-types-ctrl"><h4>Types</h4></label><i>Loading</i></div><div id="sidenav-modules"><label for="sidenav-modules-ctrl"><h4>Modules</h4></label><i>Loading</i></div><div id="sidenav-files"><label for="sidenav-files-ctrl"><h4>Files</h4></label><i>Loading</i></div><a href="license.html"><div><h4>License</h4></div></a></nav><div id="push-footer"></div></div><footer><a href="https://github.com/jleyba/js-dossier">Generated by dossier</a></footer><script src="types.js"></script><script src="dossier.js"></script>
